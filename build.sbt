...
inThisBuild(Seq(
  ...
  organization := "com.sky.ukiss.spawner",
  scalacOptions ++= Seq(
    "-feature",
    "-deprecation",
    "-unchecked",
...
val commonSettings = Seq(
  moduleName := "pipeline-spawner-" + moduleName.value,
)
...
lazy val root = project.in(file("."))
  ...
  .settings(
    ...
    Compile / mainClass := Some("com.sky.ukiss.spawner.backend.Launcher")
  )
...
lazy val frontend = project.in(file("frontend"))
  ...
  .settings(
    ...
    Compile / mainClass := Some("com.sky.ukiss.spawner.frontend.JSLauncher"),
    ...
    compileCss := Def.taskDyn {
      ...
      dir.mkdirs()
      (backend / Compile / runMain).toTask(s" com.sky.ukiss.spawner.backend.css.CssRenderer $path false")
    }.value,
