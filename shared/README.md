...
* `com.sky.ukiss.spawner.shared.css` - definition of application stylesheets.
* `com.sky.ukiss.spawner.shared.i18n` - definition of translations used in the application.
* `com.sky.ukiss.spawner.shared.model` - model classes which are useful in the RPC communication.
* `com.sky.ukiss.spawner.shared.rpc` - RPC interfaces for bidirectional client-server communication.
